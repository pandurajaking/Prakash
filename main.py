        ...
        for i in range(arg, len(links)):
            ...
            if "videos.classplus" in url:
                ...
                headers = {
                    ...
                    'region'         : 'IN',
                    'licence': "https://license.vdocipher.",
